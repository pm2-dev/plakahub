  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-[#0a1628] px-4 pt-16">
      ...
      <div className="relative z-10 flex w-full max-w-xl flex-col items-center gap-6">
        ...
        >
          <div className="border-4 border-[#006FDF] bg-[#112240] p-1">
            <div className="flex items-stretch">
              ...
              <input
                ...
                autoComplete="off"
                spellCheck={false}
                className="h-[68px] flex-1 bg-[#112240] px-4 font-mono text-2xl font-extrabold uppercase tracking-[0.2em] text-white outline-none placeholder:text-white/30 sm:text-3xl"
              />

              <button
                type="submit"
                aria-label={t.home.ariaLabel}
                className="flex w-20 items-center justify-center bg-[#FFC812] text-[#0a1628] hover:bg-white transition-colors"
              >
